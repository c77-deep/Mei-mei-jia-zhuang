...
@REM MAVEN_HOME - location of a Maven home dir
...
IF NOT EXIST "%MAVEN_PROJECTBASEDIR%\.mvn\wrapper\maven-wrapper.jar" (
    ...
    echo    from https://repo.maven.apache.org/maven2/org/apache/maven/wrapper/maven-wrapper/3.2.0/maven-wrapper-3.2.0.jar
    powershell -Command "&{"^
...
@REM Provide a "standardised" way to retrieve the CLI args that will
